...
TOPICS = [
    ("gettingstarted", "Getting Started With Python in 3ds Max",
     f"help.autodesk.com/view/MAXDEV/{MAX_VERSION}/ENU/?guid=Max_Python_API_tutorials_creating_the_dialog_html"),
    ...
    ("pymxs", "Pymxs Online Documentation",
     f"help.autodesk.com/view/MAXDEV/{MAX_VERSION}/ENU/?guid=Max_Python_API_using_pymxs_html"),
